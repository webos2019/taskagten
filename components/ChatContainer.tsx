    ...
    <div className="flex h-screen flex-col bg-gray-50 dark:bg-gray-950">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <button
                        ...
                        className="mt-3 rounded-lg bg-white px-3 py-1.5 text-xs font-medium text-red-700 shadow-sm ring-1 ring-red-200 transition-colors hover:bg-red-50 dark:bg-gray-900 dark:text-red-400 dark:ring-red-800 dark:hover:bg-red-950"
                      >
                        重试
                      </button>
                    </div>
      ...
      <div className="border-t border-gray-200 bg-white/80 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-900/80">
        {isStreaming ? (
          ...
          <div className="mx-auto flex max-w-3xl items-center justify-center gap-2 px-4 py-3 text-sm text-gray-500 dark:text-gray-400">
